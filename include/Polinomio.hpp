...
struct Polinomio : Curva {
       ...
       Polinomio (double quota, double amp, std::vector<double> q, double r1, double r2, double b1, double b2) : Curva(quota, amp, r1, r2, b1, b2), Q{q} {};  
       ...
       Polinomio (std::ifstream& inp, double r1, double r2, double b1, double b2);   // load info from file
