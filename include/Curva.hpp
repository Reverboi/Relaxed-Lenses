...
struct Curva{
	...
	double IndiceRossoSotto,// d = rosso
		...
		IndiceBluSopra;
	Curva (double quota, double amp, double r1, double r2, double b1, double b2) : Ampiezza(amp), Quota(quota), IndiceRossoSotto(r1), IndiceRossoSopra(r2), IndiceBluSotto(b1), IndiceBluSopra(b2) {};
