...
struct Punti : Curva {
       std::vector<Punto> P;
       Punti (double quota, double amp, std::vector<Punto> q, double r1, double r2, double b1, double b2) : Curva(quota, amp, r1, r2, b1, b2), P{q} {};
       ...
       Punti(std::ifstream& inp, double quota, double ampiezza, double r1, double r2, double b1, double b2);   // load info from file
